...
size_t natoms = 3, ndim = 2 , n_repeat = 4800;
...
int main(){    
    ...
    double a = 4.0*sqrt(2), mpow = 2, alpha = -0.5, D0 = 2.0;         
    std::cout<<"before the initialization of Potential" <<std::endl;
    ha::InversePowerPeriodicParticlewiseNoiseCellLists<2> pot(mpow,a,alpha, D0, radii,boxv);
    std::cout<<"Potential is initialized" <<std::endl;
    ...
    std::cout<<"the calculation for displacements starts" <<std::endl;
    ...
    std::cout<<"the calculation for displacements finishes" <<std::endl;
