#ifndef SIPS_CELL_LIST_POTENTIAL_WITH_SELECTIVE_BATCH_HPP
#define SIPS_CELL_LIST_POTENTIAL_WITH_SELECTIVE_BATCH_HPP
...
public:    
    ...
    virtual void insert_atom_pair(const size_t atom_i, const size_t atom_j, const size_t isubdom)
    {
        ...
        unsigned long ivisited_pairs = m_nvisited_pairs[isubdom] + m_acc_pairs->at(isubdom);
        if (sqrt(r2) < radius_sum ) { //chech if atom i and std::fill::fillj is a pair of neighbours
            m_nvisited_pairs[isubdom] ++;
