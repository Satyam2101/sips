#ifndef _HYPERALG_CELL_LIST_POTENTIAL_HPP
#define _HYPERALG_CELL_LIST_POTENTIAL_HPP
...
public:
                                      ...
                                      const double cutoff_factor = 1.0)
    {
        ...
        update_iterator(coords);
        NeighborAccumulator<distance_policy> accumulator(
             m_dist, coords, m_radii, (1) * cutoff_factor, include_atoms);
...
#endif //#ifndef _HYPERALG_CELL_LIST_POTENTIAL_HPP
